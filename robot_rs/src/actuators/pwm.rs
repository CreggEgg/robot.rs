use wpilib_hal::{
    hal_safe_call, HAL_DigitalHandle, HAL_FreePWMPort, HAL_GetPWMPosition, HAL_GetPWMSpeed,
    HAL_GetPort, HAL_InitializePWMPort, HAL_LatchPWMZero, HAL_SetPWMConfigMicroseconds,
...
impl PWM {
    ...
    pub fn set_raw(&mut self, value: f64) {
        hal_safe_call!(HAL_SetPWMSpeed(self.handle, value)).unwrap();
